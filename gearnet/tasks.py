...
# @R.register("tasks.MultiTaskPredictionFGM")
# class MultiTaskPredictionFGM(tasks.Task, core.Configurable):
#     eps = 1e-10
...
#         super(MultiTaskPredictionFGM, self).__init__()
...
class HierarchyTaskPrediction(tasks.Task, core.Configurable):
    ...
    def predict(self, batch, all_loss=None, metric=None):
        ...
        # ]
        pred = []
        # prefix = torch.as_tensor([], device=output["graph_feature"].device)
